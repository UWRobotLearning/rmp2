...
if __name__ == "__main__":
    ...
    experiment_name = env + '-nn-' + str(nn_size) + '-lr-' + str(lr) + \
        ...
        '-obs-num' + str(obs_num) + '-ar-' + str(goal_angle_range) + \
        '-mr-' + str(goal_minor_radius) + '-fixed_init'
    ...
    # results = tune.run(args.run, config=config, stop=stop, checkpoint_freq=args.checkpoint_freq, checkpoint_at_end=True)
